...
* 启动脚本  
  `wget --no-check-certificate -O gost.sh https://ghproxy.com/https://raw.githubusercontent.com/DingKuiqing/Multi-EasyGost/master/gost.sh && chmod +x gost.sh && ./gost.sh`  
